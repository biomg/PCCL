...
def infer_pvalue(train_data, test_data, p_value = 1e-5, nk_random = 20, 
    ...
    '''
    model = CNN3(512, 128, device, dtype)
    ...
    '''
    #use training inference directly
    model = model_name
    ...
    if pretrained:
        ...
        with autocast():
            emb_train = model(esm2_embedding(ec_id_dict_train, device, dtype))
        
    emb_test = model_embedding_test_esm2(id_ec_test, model, device, dtype)
    #获取 esm2-fc后的test序列 与 esm2-fc后的EC聚类中心的距离
